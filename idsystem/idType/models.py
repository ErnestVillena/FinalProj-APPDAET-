...
class IdType(models.Model):
    ...
    """
    idType_name = models.CharField(max_length=100, unique=True, verbose_name="ID Type Name")
    idType_desc = models.TextField(blank=True, null=True, verbose_name="Description")
